namespace BibtexEntryManager.Error
{
    public static class ErrorMessages
    {
        ...
        public const string CiteKeyRequired = "The cite key is required";
        ...
        public const string AuthorIsRequired = "The author is required";
        ...
        public const string FileContentLengthError = "The file length is too short. Please upload a file with a length greater than 0.";
