...
The design section sets out to outline the way in which the solution was built, including modelling of the problem with the requirements from the previous chapter in mind. 
